...
const MainInput = (props) => {
  ...
  return (
    <div className='relative' onSubmit={handleSubmit}>
        ...
        <input id={props.label} type="number" placeholder='0' value={props.value} onChange={handleChange}  className={ message ? 'very-light-grayish-cyan-bg grayish-cyan text-2xl text-right  h-12 w-full cursor-pointer input-error rounded-lg' : 'very-light-grayish-cyan-bg grayish-cyan text-2xl text-right  h-12 w-full cursor-pointer rounded-lg'}/>
